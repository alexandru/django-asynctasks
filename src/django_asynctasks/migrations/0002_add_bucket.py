...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsyncTask.bucket'
        db.add_column('django_asynctasks_asynctask', 'bucket', self.gf('django.db.models.fields.CharField')(default='__default__', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AsyncTask.bucket'
        db.delete_column('django_asynctasks_asynctask', 'bucket')
